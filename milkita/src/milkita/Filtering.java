...
public static String Filter(String s){
		...
		hasil = hasil.replaceAll(" menjadi | tetap | akhirnya | merupakan | seharusnya | ternyata | hanya | lainnya | tersebut | yang | agar | supaya | biar | jika | kalau | jikalau | asal | asalkan | bila | manakala | sejak | semenjak | sedari | sewaktu | tatkala | ketika | sementara | begitu | seraya | selagi | selama | serta | sambil | demi | setelah | sesudah | sebelum | sehabis | selesai | seusai | hingga | sampai | andaikan | seandainya | umpamanya | sekiranya | biar | biarpun | walau | walaupun | sekali | sekalipun | sungguhpun | kendati | kendatipun | seakan-akan | seolah-olah | seakan | seolah | sebagaimana | seperti | sebagai | laksana | sedangkan | ibarat | daripada | alih-alih | sebab | karena | oleh | sehingga | sampai | maka | dengan | tanpa | bahwa ", " ");
		...
		hasil = hasil.replaceAll(" juga | sudah | adalah | kata | tapi | depan | belakang | akan | ini | itu | tak | tidak | dari | dan | pada | untuk "," ");
		...
		hasil = hasil.replaceAll(" - |\\s?--\\s?"," ");
                ...
                hasil = hasil.replaceAll("perusahaan | pt | aneka |tempo co "," ");
